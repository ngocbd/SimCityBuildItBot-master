namespace SimCityBuildItBot.Bot
{
    ...
    public static class Constants
    {
        public static Point GetPoint(Location location)
        {
            switch (location)
            {
                case Location.CentreMap: return new Point(645, 360);
                ...
                //case Location.FirstFactory: return new Point(735,435);
                case Location.FirstFactory: return new Point(820, 555);
                case Location.FirstStore: return new Point(1000, 550);
                case Location.SecondStore: return new Point(1130, 640);
                case Location.TradeDepot: return new Point(207, 307);
                    

                case Location.CenterFactory: return new Point(634, 338);
                case Location.FactoryResource1: return new Point(470, 250);
                case Location.ButtonLeftInner1: return new Point(470, 250);
                case Location.ButtonLeftInner2: return new Point(424, 336);
                case Location.ButtonLeftInner3: return new Point(478, 427);
                ...
                case Location.ButtonRightInner1: return new Point(804, 246);
